...
Y el asentir engaña. Quien no ha entendido no lo dice: por vergüenza, por prisa o porque el idioma es el suyo a medias. La única forma de saberlo es pedir que lo cuente con sus palabras. En un estudio de visitas grabadas, en diabetes, los médicos que comprobaban así lo explicado tenían pacientes con mejor control, y solo lo hacían en una de cada cinco visitas (Schillinger 2003). Se llama teach-back; yo lo llamo pregunta de vuelta.
...
Lo que no hace: no sabe qué entiende esta persona, si la traducción dice lo mismo ni qué palabra hiere en esta consulta. "Nivel de lectura de 12 años" en el prompt no es una garantía: es un encargo, y se comprueba. El índice de Flesch-Szigriszt cuenta en español sílabas por palabra y palabras por frase, y la escala INFLESZ lo interpreta (Barrio-Cantalejo 2008); el caso 1 pide lo mismo y te manda contar una muestra a mano.
...
Todo texto que llega a la persona termina igual (capítulos 3 y 4): el contacto, como hueco "[FALTA: contacto del centro]"; cuándo no esperar, con "urgencias o 112", solo si toca síntomas o tratamiento; y el aviso de material informativo, en usted si se imprime o se envía. Lo nuevo: en otro idioma no se improvisan en cada hoja; se validan una vez y se pegan (caso 2). El hueco sigue siendo hueco en cualquier idioma y el 112 sigue siendo 112. Una hoja en árabe con la línea de urgencias mal traducida es peor que ninguna hoja.
...
**Qué revisar antes de usarla.** Cuenta tú una muestra: tres frases, palabras con el dedo; el modelo cuenta mal y redondea bien. Las dos frases que niegan la culpa se quedan porque el prompt las protege; si el modelo las cambió por "no depende de usted", "no está en su mano", "no puede hacer nada" o "usted no ha hecho nada mal", no dicen lo mismo: son la forma en que la máquina niega la culpa, y le quitan a la persona lo que sí es suyo. Si aparecen, la frase la escribes tú. Las palabras largas no son un fallo: son las que la persona tiene que poder leer; si son más de cinco en cien palabras, la hoja pesa. Con LÍNEA DE URGENCIAS "ninguna", busca "consulte" y "112": si están, la máquina ha decidido por ti que la hoja toca síntomas. Si la persona no sabe contarlo, la que se explicó mal fui yo: se repite con otras palabras, no más alto, y se vuelve a preguntar. Una pregunta por visita; la más importante es la que toca lo que hay que hacer.
...
**Qué revisar antes de usarla.** Un NO en CONTACTO, URGENCIAS o AVISO no se negocia: se rehace esa línea en A y se vuelve a retraducir. Las demás diferencias las decides tú con el hablante delante; la máquina señala, no arbitra. El original entra en un segundo mensaje, nunca en el primero; si el modelo dice que ha "revisado" su retraducción al verlo, la comparación no vale: conversación nueva. El 112 se busca con el buscador: si no lo encuentra, está en otra grafía. Las tres líneas se traducen y se validan una sola vez por idioma, con el mediador o el teléfono de interpretación (si tu servicio de salud tiene versiones oficiales, esas), y se guardan en la ficha del caso; desde entonces se pegan, y la máquina no vuelve a tocar la del 112. La hoja corregida a mano es la que se guarda. Lo que ninguna herramienta te dirá: para muchas personas del Magreb el árabe escrito no es el idioma de casa, y hay quien no lee en ninguno. Se pregunta qué lee y en qué idioma antes de traducir; si la respuesta es "nada", el material es oral (capítulo 9). La ley pide información comprensible y adecuada a la persona (Ley 41/2002, art. 4.2), no una hoja en su idioma. "Revisado por su profesional sanitario" sigue siendo verdad en árabe si la revisión es esta: la retraducción, el hablante y tu nombre al pie. Respondes tú de la traducción (art. 4.3); el mediador comprueba, no firma. Ningún aviso más: el que lleva ya dice que hubo máquina. En un estudio de instrucciones de alta traducidas con un traductor automático, la mayoría se entendía y unas pocas podían hacer daño (Khoong 2019).

**Riesgo principal y mitigación.** Entregar la traducción "porque la retraducción salió limpia". Mitigación: sin hablante, no se entrega; sin mediador ni líneas finales validadas en ese idioma, la hoja no se entrega en papel: se lee juntos la versión en español, frase corta y pregunta de vuelta, y el material es oral (capítulo 9).
...
**Qué revisar antes de usarla.** El mecanismo, contra la ficha técnica del principio activo que vas a prescribir (CIMA, AEMPS): la máquina explica muy bien mecanismos que no son el de tu fármaco. Los efectos del ejemplo son los de los fármacos que imitan hormonas del intestino (GIRO 2024; Wharton 2020); con otro principio activo, los cambias tú con la ficha técnica delante: no los añades, los sustituyes. Busca "kilos", "%", "perderá", "agonista", "familia", "inyección", cualquier sigla de hormona y "azúcar" fuera de la línea que le diste: si están, el recuento miente. Si el guion dice que el tratamiento "también regula el azúcar", lo has dicho tú o no se dice: en una persona con diabetes es una afirmación clínica, no una explicación. Si toma medicación para la diabetes que puede bajar el azúcar, lo que haces con ella lo decides antes de la primera dosis (capítulo 8); el guion solo enseña a reconocer el azúcar bajo. Si la persona puede quedarse embarazada, esa frase no se salta; qué anticoncepción y con cuánta antelación se deja el fármaco lo miras tú en la ficha técnica (capítulo 8). Si no sabe decir cuándo no esperar, la línea se repite, no se da por dicha. "Sin culpa" en el bloque de dejar no es adorno: quien se siente juzgado no vuelve a contarlo. Dos cosas que el guion no dice: lo que le explicas consta en la historia, porque la información se da de palabra (Ley 41/2002, art. 4.1), y estos bloques son lo que la ley pide antes de decidir juntos (art. 10.1). Si algún día lo imprimes, deja de ser guion: pasa por el caso 1 y lleva las tres líneas.

**Riesgo principal y mitigación.** Que el guion prometa. Mitigación: "qué es ir bien" sin cifras y con la valoración a los meses dicha el primer día; y tu frase de la puerta, que dice quién construye.
...
**Situación.** El mensaje corto entre visitas ya está en el capítulo 4 (caso 6, mensaje 2). Esta hoja es para cuando el mensaje no basta: la persona ha empezado un tratamiento que da molestias digestivas los primeros días y quiere saber qué hacer en casa. No nombra el tratamiento, vale para cualquiera que las dé y no cambia una pauta: eso es consulta (nota del caso 3). Si contesta contando un efecto adverso, entra la frase del capítulo 3 y se notifica.
...
**Qué revisar antes de usarla.** Busca "dosis", "tome", "deje", "normal", "funciona", "jengibre" y "farmacia": los tres modelos los escriben de vez en cuando ("si persiste, puede tomar…", "consulte en la farmacia") y cuentan cero. Las medidas de casa son las de las recomendaciones prácticas para las molestias digestivas al empezar (Wharton 2022; GIRO 2024) y las de la ficha técnica de tu principio activo (CIMA, sección 4.8) [VERIFICAR en CIMA la duración de cada molestia para el principio activo que prescribas]; si el tuyo pide otra cosa (por ejemplo, una regla de toma en ayunas o con la comida), la pones tú y compruebas que la hoja no la contradice. Si toma medicación para la diabetes que puede bajar el azúcar, lo que haces con ella lo decides antes de la primera dosis (capítulo 8); la hoja solo enseña a reconocer el azúcar bajo. La línea de urgencias dice con palabras de casa lo que tú sabes que hay detrás: dolor fuerte que no cede o va a la espalda (páncreas), dolor bajo las costillas derechas (vesícula), no tolerar líquidos (deshidratación y riñón). Lo que no dice, lo dices tú en la visita del caso 3: fiebre o piel amarilla también son urgencias. En quien vomita o no bebe, lo que se para esos días lo decides tú (capítulo 8). Cuando te devuelva la hoja leída, pregunta lo que la hoja no pregunta: qué come de verdad, si vomita a diario, si bebe, si se está saltando comidas a propósito. Antes de imprimir, las diez preguntas del anexo B; el contacto se rellena en tu sistema.
...
**Qué revisar antes de usarla.** Busca "importante", "preocupados", "seguimiento", "avergonzarse" y "objetivos": los tres primeros son reproches que pasan el recuento; el cuarto discute lo que la persona siente; el quinto le pone una nota. "No ha servido de nada" se contesta sin defender el tratamiento anterior: recoger, no discutir (Miller 2013). Las opciones que se ofrecen existen en tu agenda, o la llamada hace daño. El bloque de "si cuenta otra cosa" no se lee a la persona: es para quien llama, y con ideas de muerte la cita es el mismo día (capítulo 5). Y si contesta otra persona, el guion tiene una frase y ninguna más: el secreto también va por teléfono (capítulo 3). Con quien entiende el español a medias, la llamada no explica: recoge, ofrece la cita y la confirma con una pregunta de vuelta ("¿me dice a qué hora viene?"); mediador o teléfono de interpretación si existen. El criterio son dos citas seguidas; con barrera idiomática puedes no esperar a la segunda, y lo anotas.
...
**Qué revisar antes de usarla.** Cuenta las palabras con el dedo, y no cuentes la línea de contacto, que el modelo cuenta la mitad de las veces: la máquina escribe 24 donde hay 29. Busca "lucha" y "¿": la primera está en la lista y pasa; la segunda es un titular que el cartel no pidió. Lee cada variante como la leería alguien que no quiere que le hablen del peso: "aquí se trata" tiene que sonar a puerta, no a citación. Un cartel no es material informativo para una persona: no lleva el pie de las hojas; lleva el contacto del centro, y ninguna marca. El contacto es también su firma: dice de quién es, y por eso no se quita. Si tu consulta es privada, un cartel que dice "aquí se trata" es publicidad sanitaria y tiene su norma en tu comunidad [VERIFICAR: normativa autonómica de publicidad sanitaria]; en un centro público lo autoriza quien autoriza lo demás, como la hoja sobre IA del capítulo 3.
...
**Situación.** "Esto es light, ¿no?" En la consulta, la etiqueta se lee juntos, con el dedo en la lista de ingredientes; ahí no hay móvil que valga. La IA sirve para preparar el taller o la hoja: diez etiquetas de letra diminuta convertidas en tablas en una tarde. Y "light" no es una opinión: la ley exige al menos un 30 % menos de algo respecto a un producto similar y obliga a decir de qué (Reglamento 1924/2006); lo que no dice es qué lleva a cambio.
...
Entre cincuenta y cincuenta y cinco años. Nació en el Magreb, lleva años trabajando en el campo y habla un español de trabajo: el que hace falta en el campo y en el mostrador, no para una hoja de dos caras. Obesidad de grado II y diabetes tipo 2 con tratamiento oral. Asiente a todo. No vuelve.
...
4. Las tres líneas y el aviso van en toda hoja, también en árabe, validadas una vez por idioma; los guiones y el cartel quedan fuera.
...
5. Khoong EC, Steinbrook E, Brown C, Fernandez A. Assessing the use of Google Translate for Spanish and Chinese translations of emergency department discharge instructions. JAMA Intern Med. 2019;179(4):580-2. doi:10.1001/jamainternmed.2018.7653
6. Ley 41/2002, de 14 de noviembre, básica reguladora de la autonomía del paciente y de derechos y obligaciones en materia de información y documentación clínica. BOE núm. 274, de 15 de noviembre de 2002 (BOE-A-2002-22188). Arts. 4.1, 4.2, 4.3, 5.1 y 10.1.
...
9. Agencia Española de Medicamentos y Productos Sanitarios. Centro de Información online de Medicamentos (CIMA) [Internet]. Madrid: AEMPS [consultado el 13 de septiembre de 2026]. Fichas técnicas autorizadas por principio activo, sección 4.8 (reacciones adversas). Disponible en: https://cima.aemps.es
17. Wharton S, Davies M, Dicker D, Lingvay I, Mosenzon O, Rubino DM, et al. Managing the gastrointestinal side effects of GLP-1 receptor agonists in obesity: recommendations for clinical practice. Postgrad Med. 2022;134(1):14-9. doi:10.1080/00325481.2021.2002616
