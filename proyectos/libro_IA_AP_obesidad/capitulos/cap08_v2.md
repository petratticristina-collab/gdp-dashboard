...
- **Lo que la máquina no pide y la lista sí:** tabaco; lípidos; B12 con metformina; AST y plaquetas para el FIB-4, que la ADA 2025 pide en toda diabetes tipo 2, también con transaminasas normales (Sterling 2006; ADA 2025, sección 4, rec. 4.22a); una ALT que baja no lo cierra, y el alcohol y las serologías del capítulo 4 siguen pendientes; cociente albúmina/creatinina; pies. Y el fondo de ojo aquí no es rutina: con la HbA1c bajando más de un punto en meses y esta clase, se comprueba que está hecho y reciente, y si ya había retinopatía, se vigila (ADA 2025, sección 12; CIMA, 4.4 [VERIFICAR]). Lo que se deriva lo dice la cifra, no la máquina: FIB-4 de 1,3 o más (2,0 a partir de los 65) pide un segundo test y de 2,67 o más, hepatología; albúmina/creatinina de 30 o más confirmada es riñón y cambia el tratamiento (ADA 2025, rec. 4.23; KDIGO 2024 [VERIFICAR]). La hipertensión "de consulta" del capítulo 4 se confirma con tomas repetidas, AMPA o MAPA antes de tratar, salvo cifras de 180/110 o más o daño de órgano, que no esperan (Mancia 2023); en el hombre de este caso, ya tratado, la AMPA dice si el IECA basta y el objetivo en diabetes lo da la guía (ADA 2025, sección 10). Ante nicturia en un hombre de sesenta y pico: azúcar, próstata y cribado de apnea con STOP-Bang (Chung 2008), en ese orden; y la somnolencia de quien ya lleva presión positiva se reevalúa, no se criba (capítulo 5).
