...
.contra .sin { font-family: 'Source Serif 4', Georgia, serif; font-size: 9.6pt; line-height: 1.45; }
.contra .sin p { margin: 0 0 3mm; }
.contra .sin em { color: var(--deep); }
.contra ul { margin: 2mm 0 5mm; padding-left: 5mm; font-size: 9pt; line-height: 1.4; }
.contra li { margin-bottom: 1.2mm; }
.contra li::marker { color: var(--green); }
.contra .bio { display:flex; gap: 5mm; align-items:flex-start; border-top: 1px solid #d7dde3; padding-top: 4mm; margin-top:auto; }
.contra .foto { width: 24mm; height: 30mm; background: #eef3f3; border: 1px dashed var(--grey); color: var(--grey); font-size: 6.5pt; display:flex; align-items:center; justify-content:center; text-align:center; flex-shrink:0; }
.contra .bio p { font-size: 7.8pt; line-height: 1.4; margin:0; }
