...
.tapa h1 { font-family: 'Source Serif 4', Georgia, serif; font-weight: 600; font-size: 40pt; line-height: 0.98; margin: 9mm 0 4mm; letter-spacing: -0.5px; }
...
LOMO_HTML = f'<div class="lomo"><div class="txt"><b>IA en la consulta de salud</b> Dra. Cristina B. Petratti · Médica de familia, especialista en obesidad</div><img class="logo" src="{LOGO_MARIPOSA}" alt=""></div>'
